<div class="mb-3 row">
    ...
    <div class="col-md-10">
        <input class="form-control" type="date"
            value="{{ !empty($data) ? $data->tgl_transaksi : old('tgl_transaksi') }}" name="tgl_transaksi">
    ...
    <div class="col-md-10">
        <select class="form-control" name="kode_akun" id="kode_akun">
            ...
            @foreach ($akuns as $akun)
                <option {{!empty($data) ? $data->kode_akun == $akun->id? "selected" : "" :""}}
...
<div class="mb-3 row">
    ...
    <div class="col-md-10">
        <input class="form-control" type="text" value="{{ !empty($data) ? $data->judul : old('judul') }}"
            name="judul" placeholder="Masukkan judul pengeluaran ... ">
...
<div class="mb-3 row">
    ...
    <div class="col-md-10">
        <input class="form-control" type="text" value="{{ !empty($data) ? $data->nominal : old('nominal') }}"
            name="nominal" placeholder="Masukkan nominal pengeluaran ... ">
...
<div class="card-body">
    <div class="form-group mb-0 text-end">
        <button type="submit" class="btn btn-primary waves-effect btn-label waves-light"><i
                class="bx bx-save label-icon"></i>Save</button>
